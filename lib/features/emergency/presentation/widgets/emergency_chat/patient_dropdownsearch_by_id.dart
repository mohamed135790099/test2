...
class PatientDropDownSearchById extends StatefulWidget {
  const PatientDropDownSearchById({super.key});

  @override
  State<PatientDropDownSearchById> createState() =>
      _PatientDropDownSearchByIdState();
}

class _PatientDropDownSearchByIdState extends State<PatientDropDownSearchById> {
  @override
    ...
    return BlocBuilder<ReservationCubit, ReservationState>(
      builder: (context, state) {
        ...
        return DropdownSearch<GetAllUsers>(
          ...
          items: patientNames,
          onChanged: reservationCubit.setPickModelForId,
          selectedItem: null,
