...
class WaitingReservationListByDate extends StatelessWidget {
  const WaitingReservationListByDate({super.key});
        ...
        return filteredByStatus.isEmpty
            ? Column(
                children: [
                  ...
                  const Center(child: Text('لا توجد حجوزات في الانتظار')),
                ],
              )
            : SizedBox(
                height: 450.h,
